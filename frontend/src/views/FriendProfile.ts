...
export async function renderFriendProfile(appElement: HTMLElement): Promise<void> {
    ...
    try {
        ...
        <div class="h-screen flex flex-col items-center p-4 text-white">
            <div class="w-full flex justify-center mt-10 md:mt-20 mb-8 flex-shrink-0">
            ...
            <div class="w-full max-w-7xl overflow-y-auto flex-grow mb-4">
             ...
             <button id="backButton" class="flex-shrink-0 relative w-[250px] h-[75px] cursor-pointer transform hover:scale-125 transition-transform duration-200 focus:outline-none focus:ring-4 focus:ring-cyan-300 rounded-lg mt-auto">
